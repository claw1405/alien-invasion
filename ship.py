...
class Ship(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        self.image = pygame.transform.scale(self.image, (75, 60))  # Resize
        self.rect = self.image.get_rect()

        # Start each new ship near the bottom center of the screen
        self.rect.midbottom = self.screen_rect.midbottom
        self.rect.y -= 15  # Slightly above bottom edge
    ...
    def update(self):
        ...
        # Move right or left depending on key press
